...
# ┌─(✔)───(ethan)───(~/Documents)───(master) *colored
# └> $ cd ..
PS1='\n \[\e[00;34m\]┌─(`if [ \$? = 0 ]; then echo "\[\e[01;32m\]✔"; else echo "\[\e[01;31m\]✘"; fi`\[\e[00;34m\])───(\[\e[01;35m\]\u\[\e[00;34m\])───(\[\e[01;32m\]\w\[\e[00;34m\])$(__git_ps1 "───(`[[ $(git status 2> /dev/null) =~ Changes\ to\ be\ committed: ]] && echo "\[\e[01;33m\]" || echo "\[\e[01;31m\]"``[[ ! $(git status 2> /dev/null) =~ nothing\ to\ commit,\ working\ .+\ clean ]] || echo "\[\e[01;32m\]"`%s\[\e[00;34m\])")\n └> \[\e[00m\]\$ '
